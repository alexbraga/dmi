...
public class DMIApplication implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Order o1 = new Order(null, Instant.parse("2021-04-18T11:25:09Z"), OrderStatus.CONFIRMED, c1);
        Order o2 = new Order(null, Instant.parse("2021-04-20T13:30:00Z"), OrderStatus.PENDING, c1);
